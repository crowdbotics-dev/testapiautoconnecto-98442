...
## Project Structure
    ...
    ├── testapiautoconnecto_98442  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_98442`
...
2. Clone this repo and `cd testapiautoconnecto_98442`
